...
@implementation LTLayoutManager
...
- (id)init
{
	if (self = [super init]) {
		...
		attributes = [[NSDictionary alloc] initWithObjectsAndKeys:[NSUnarchiver unarchiveObjectWithData:[LTDefaults valueForKey:@"TextFont"]], NSFontAttributeName, [NSUnarchiver unarchiveObjectWithData:[LTDefaults valueForKey:@"InvisibleCharactersColourWell"]], NSForegroundColorAttributeName, nil];
		...
		[self setShowInvisibleCharacters:[[LTDefaults valueForKey:@"ShowInvisibleCharacters"] boolValue]];
