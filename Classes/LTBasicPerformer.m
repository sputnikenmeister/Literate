...
- (NSString *)genererateTemporaryPath
{
	...
	do {
		sequenceNumber++;
		temporaryPath = [NSString stringWithFormat:@"%d-%d-%d.%@", [[NSProcessInfo processInfo] processIdentifier], (NSInteger)[NSDate timeIntervalSinceReferenceDate], sequenceNumber, @"Literate"];
