...
- (id)initWithFrame:(NSRect)frameRect pullsDown:(BOOL)flag
{
    ...
    if (self) {
        ...
        _PSMTabBarOverflowPopUpImage = [[NSImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"LTTabBarOverflow" ofType:@"pdf" inDirectory:@"Tab Bar"]];
		_PSMTabBarOverflowDownPopUpImage = [[NSImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"LTTabBarOverflowPressed" ofType:@"pdf" inDirectory:@"Tab Bar"]];
    }
    return self;
}
