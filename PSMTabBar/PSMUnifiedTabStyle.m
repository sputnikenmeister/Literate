...
- (id) init
{
    if((self = [super init]))
    {
        unifiedCloseButton = [[NSImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"LTTabBarClose" ofType:@"pdf" inDirectory:@"Tab Bar"]];
        unifiedCloseButtonDown = [[NSImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"LTTabBarClosePressed" ofType:@"pdf" inDirectory:@"Tab Bar"]];
		unifiedCloseButtonOver = [[NSImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"LTTabBarCloseRollover" ofType:@"pdf" inDirectory:@"Tab Bar"]];
